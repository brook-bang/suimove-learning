module satoshi_flip::single_player_satoshi {
    ...
    use satoshi_flip::house_data;
    use satoshi_flip::counter_nft::Counter;
    use satoshi_flip::house_data::{HouseData, house};

    const EPOCHS_CANCEL_AFTER: u64 = 7;
    const GAME_RETRUN: u8 = 2;
    ...
    public fun fee_in_pb(game: &Game): u16 {
        game.fee_bp
    }

    public fun fee_amount(game_stake: u64,fee_in_bp: u16): u64 {
        ((((game_stake / (GAME_RETRUN as u64)) as u128) * (fee_in_bp as u128) /10_000) as u64)
    }
